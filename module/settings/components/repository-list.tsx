      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          {repositories && repositories.length > 0 && (
            ...
            >
              <AlertDialogTrigger className="inline-flex items-center justify-center gap-2 rounded-md bg-destructive px-3 py-2 text-sm font-medium text-destructive-foreground shadow-xs hover:bg-destructive/90">
          ...
          <div className="space-y-4">
            {repositories.map((repo) => (
              ...
              >
                ...
                <AlertDialog>
                  <AlertDialogTrigger className="ml-4 inline-flex items-center justify-center rounded-md p-2 text-destructive hover:bg-destructive/10">
                    <Trash2 className="h-4 w-4" />
                  </AlertDialogTrigger>
