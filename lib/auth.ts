...
export const auth = betterAuth({
  ...
  trustedOrigins:["https://localhost:3000","https://octane-lark-astride.ngrok-free.dev/"],
  plugins: [
    polar({
      client: polarClient,
      ...
      use: [
        checkout({
          products: [
            {
              productId: "383ef628-8156-43ec-82f4-5843ec748fcb",
              slug: "CodeRev", // Custom slug for easy reference in Checkout URL, e.g. /checkout/CodeRev
            },
          ],
